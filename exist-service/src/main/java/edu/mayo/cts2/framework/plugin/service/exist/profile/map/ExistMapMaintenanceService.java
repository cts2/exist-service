...
import edu.mayo.cts2.sdk.service.profile.map.MapMaintenanceService;

@Component
public class ExistMapMaintenanceService
	extends AbstractExistService<edu.mayo.cts2.sdk.model.service.map.MapCatalogMaintenanceService>  
